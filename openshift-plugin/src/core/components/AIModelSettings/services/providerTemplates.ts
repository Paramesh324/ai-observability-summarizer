...
export const PROVIDER_TEMPLATES: Record<Provider, ProviderTemplate> = {
  ...
  ibm: {
    ...
    description: 'IBM WatsonX.ai - Enterprise AI platform with Llama and Granite models',
    defaultEndpoint: 'https://us-south.ml.cloud.ibm.com/ml/v1/text/chat',
    requiresApiKey: true,
    iconClass: 'fa-robot',
    color: '#0f62fe',
    commonModels: ['llama-3-1-70b-instruct', 'granite-13b-chat-v2'],
    documentationUrl: 'https://cloud.ibm.com/docs/watsonxai',
  },
  internal: {
    provider: 'internal',
